...
(function(exports) {
  ...
  var transitionGroup = Data_Function_Uncurried.runFn1($foreign.transitionGroup_);
...
(function(exports) {
  ...
  var view = function (model) {
      var f = function (index) {
          return function (value) {
              return Hedwig_Element.div([ Hedwig_Foreign.key(Data_Show.show(Data_Show.showInt)(value)), Hedwig_Event.onClick(new Remove(index)) ])([ Hedwig_Foreign.text(Data_Show.show(Data_Show.showInt)(value)) ]);
          };
      };
      return Hedwig_Element.main([ Hedwig_Property.id("main") ])([ Hedwig_Element.button([ Hedwig_Event.onClick(Add.value) ])([ Hedwig_Foreign.text("Add") ]), Hedwig_Element.button([ Hedwig_Event.onClick(Shuffle.value) ])([ Hedwig_Foreign.text("Shuffle") ]), Hedwig_Element.div([ Hedwig_Foreign.transitionGroup("bounce"), Hedwig_Property["class'"]("list") ])(Data_Array.mapWithIndex(f)(model.values)) ]);
  };
  var shuffle = function (array) {
      var length = Data_Array.length(array);
      return function __do() {
          var v = Data_Unfoldable.replicateA(Effect.applicativeEffect)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(length)(Effect_Random.randomInt(0)(length - 1 | 0))();
          return Data_Functor.map(Data_Functor.functorArray)(function (v1) {
              return v1.value1;
          })(Data_Array.sortWith(Data_Ord.ordInt)(function (v1) {
              return v1.value0;
          })(Data_Array.zip(v)(array)));
      };
  };
      ...
      return function (v) {
          if (v instanceof Add) {
              return new Data_Tuple.Tuple({
                  values: Data_Array.snoc(model.values)(model.next),
                  next: model.next + 1 | 0
              }, [  ]);
          };
          if (v instanceof Remove) {
              return new Data_Tuple.Tuple({
                  values: Data_Maybe.fromMaybe(model.values)(Data_Array.deleteAt(v.value0)(model.values)),
                  next: model.next
              }, [  ]);
          };
          if (v instanceof Shuffle) {
              return new Data_Tuple.Tuple(model, [ Hedwig.sync(Data_Functor.map(Effect.functorEffect)(Update.create)(shuffle(model.values))) ]);
          };
          ...
          throw new Error("Failed pattern match at Examples.AnimatedList line 25, column 16 - line 35, column 36: " + [ v.constructor.name ]);
      };
  };
  ...
  exports["view"] = view;
  exports["main"] = main;
})(PS["Examples.AnimatedList"] = PS["Examples.AnimatedList"] || {});
PS["Examples.AnimatedList"].main();
