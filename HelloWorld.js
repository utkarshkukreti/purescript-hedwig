...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];                 
  var main = (function () {
      var html = Hedwig_Element.main([  ])([ Hedwig_Foreign.text("Hello, world!") ]);
      var app = {
          init: new Data_Tuple.Tuple(Data_Unit.unit, [  ]),
          update: function (v) {
              return function (v1) {
                  return new Data_Tuple.Tuple(Data_Unit.unit, [  ]);
              };
          },
          view: Data_Function["const"](html)
      };
      return Hedwig_Application.mount("main")(app);
  })();
  exports["main"] = main;
})(PS["Examples.HelloWorld"] = PS["Examples.HelloWorld"] || {});
PS["Examples.HelloWorld"].main();
