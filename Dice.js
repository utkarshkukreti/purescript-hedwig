...
(function(exports) {
  ...
  var view = function (model) {
      return Hedwig_Element.main([ Hedwig_Property.id("main") ])([ Hedwig_Foreign.text(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(model)), Hedwig_Element.button([ Hedwig_Event.onClick(Roll.value) ])([ Hedwig_Foreign.text("Roll") ]) ]);
  };
  var update = function (model) {
      return function (v) {
          if (v instanceof Roll) {
              return new Data_Tuple.Tuple(model, [ Data_Functor.map(Effect_Aff.functorAff)(Update.create)(Hedwig.sync(Effect_Random.randomInt(1)(6))) ]);
          };
          if (v instanceof Update) {
              return new Data_Tuple.Tuple(new Data_Maybe.Just(v.value0), [  ]);
          };
          throw new Error("Failed pattern match at Examples.Dice line 19, column 16 - line 23, column 31: " + [ v.constructor.name ]);
      };
  };
  ...
  exports["view"] = view;
  exports["main"] = main;
})(PS["Examples.Dice"] = PS["Examples.Dice"] || {});
PS["Examples.Dice"].main();
