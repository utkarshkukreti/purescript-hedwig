...
(function(exports) {
  ...
  var view = function (model) {
      return Hedwig_Element.main([  ])([ Hedwig_Element.button([ Hedwig_Event.onClick(Prompt.value) ])([ Hedwig_Foreign.text("Hello") ]), Hedwig_Element.div([  ])([ Hedwig_Foreign.text("Hello, " + (Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(model.name) + "!")) ]) ]);
  };
  var prompt = Control_Bind.bind(Effect_Aff.bindAff)(Hedwig.sync(Web_HTML.window))(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Hedwig.sync(Web_HTML_Window.prompt("What's your name?")(v)))(function (v1) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Update(v1));
      });
  });
  var update = function (model) {
      return function (v) {
          if (v instanceof Prompt) {
              return new Data_Tuple.Tuple(model, [ prompt ]);
          };
          ...
          throw new Error("Failed pattern match at Examples.Prompt line 27, column 16 - line 31, column 32: " + [ v.constructor.name ]);
      };
  };
  ...
  exports["view"] = view;
  exports["main"] = main;
})(PS["Examples.Prompt"] = PS["Examples.Prompt"] || {});
PS["Examples.Prompt"].main();
