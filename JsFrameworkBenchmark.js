...
(function(exports) {
  ...
  var lazy = Data_Function_Uncurried.runFn4($foreign.lazy_);
  var key = Data_Function_Uncurried.runFn1($foreign.key_);                                      
  var element = Data_Function_Uncurried.runFn3($foreign.element_);
  var attribute = Data_Function_Uncurried.runFn2($foreign.attribute_);
...
(function(exports) {
  ...
  "use strict";
  var Hedwig_Foreign = PS["Hedwig.Foreign"];  
  var tr = Hedwig_Foreign.element("tr");            
  var td = Hedwig_Foreign.element("td");
  var tbody = Hedwig_Foreign.element("tbody");
  var table = Hedwig_Foreign.element("table");  
  var span = Hedwig_Foreign.element("span");
  var h1 = Hedwig_Foreign.element("h1");
  var div = Hedwig_Foreign.element("div");      
  var button = Hedwig_Foreign.element("button");
  var a = Hedwig_Foreign.element("a");
  exports["a"] = a;
...
(function(exports) {
  ...
  var Hedwig_Foreign = PS["Hedwig.Foreign"];
  var Prelude = PS["Prelude"];                   
  var type$prime = Hedwig_Foreign.property("type");
  var id = Hedwig_Foreign.property("id");            
  var href = Hedwig_Foreign.property("href");
  var class$prime = Hedwig_Foreign.property("className");
  var classList = function (array) {
      return class$prime(Data_String_Common.joinWith(" ")(Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return v.value0;
...
(function(exports) {
  ...
  var sync = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
  exports["sync"] = sync;
})(PS["Hedwig"] = PS["Hedwig"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  ...
  var UpdateEvery = (function () {
      function UpdateEvery(value0) {
          this.value0 = value0;
      };
      UpdateEvery.create = function (value0) {
          return new UpdateEvery(value0);
      };
      return UpdateEvery;
  })();
  var Clear = (function () {
  ...
  var viewRow = function (v) {
      return Hedwig_Element.tr([ Hedwig_Foreign.key(Data_Show.show(Data_Show.showInt)(v.id)), Hedwig_Property.classList([ new Data_Tuple.Tuple("danger", v.selected) ]) ])([ Hedwig_Element.td([ Hedwig_Property["class'"]("col-md-1") ])([ Hedwig_Foreign.text(Data_Show.show(Data_Show.showInt)(v.id)) ]), Hedwig_Element.td([ Hedwig_Property["class'"]("col-md-4") ])([ Hedwig_Element.a([ Hedwig_Property.href("#"), Hedwig_Foreign.attribute("data-action")("Select"), Hedwig_Foreign.attribute("data-id")(Data_Show.show(Data_Show.showInt)(v.id)) ])([ Hedwig_Foreign.text(v.label) ]) ]), Hedwig_Element.td([ Hedwig_Property["class'"]("col-md-1") ])([ Hedwig_Element.a([ Hedwig_Property.href("#") ])([ Hedwig_Element.span([ Hedwig_Property["class'"]("glyphicon glyphicon-remove"), Hedwig_Foreign.attribute("aria-hidden")("true"), Hedwig_Foreign.attribute("data-action")("Remove"), Hedwig_Foreign.attribute("data-id")(Data_Show.show(Data_Show.showInt)(v.id)) ])([  ]) ]) ]), Hedwig_Element.td([ Hedwig_Property["class'"]("col-md-6") ])([  ]) ]);
  };
  var viewRowLazy = function (row) {
      return Hedwig_Foreign.lazy("tr")(Data_Show.show(Data_Show.showInt)(row.id))(viewRow)(row);
  };
  ...
  var handleTableClick = function (event) {
      var maybeElement = Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Web_Event_Event.target(event))(Web_DOM_Node.fromEventTarget))(Web_DOM_Element.fromNode);
      if (maybeElement instanceof Data_Maybe.Just) {
          return function __do() {
              var v = Web_DOM_Element.getAttribute("data-action")(maybeElement.value0)();
              var v1 = Data_Functor.map(Effect.functorEffect)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Int.fromString))(Web_DOM_Element.getAttribute("data-id")(maybeElement.value0))();
              if (v instanceof Data_Maybe.Just && (v.value0 === "Select" && (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Data_Maybe.Just))) {
                  return new Select(v1.value0.value0);
              };
              if (v instanceof Data_Maybe.Just && (v.value0 === "Remove" && (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Data_Maybe.Just))) {
                  return new Remove(v1.value0.value0);
              };
              return NoOp.value;
          };
      };
      if (maybeElement instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value);
      };
      throw new Error("Failed pattern match at Examples.JsFrameworkBenchmark line 140, column 3 - line 148, column 25: " + [ maybeElement.constructor.name ]);
  };
  var colors = [ "red", "yellow", "blue", "green", "pink", "brown", "purple", "brown", "white", "black", "orange" ];
  var choose = function (array) {
      return function __do() {
          var v = Effect_Random.randomInt(0)(Data_Array.length(array))();
          return Data_Maybe.fromMaybe("")(Data_Array.index(array)(v));
      };
  };
  var button = function (v) {
      return Hedwig_Element.div([ Hedwig_Property["class'"]("col-sm-6 smallpad") ])([ Hedwig_Element.button([ Hedwig_Property["type'"]("button"), Hedwig_Property["class'"]("btn btn-primary btn-block"), Hedwig_Property.id(v.id), Hedwig_Event.onClick(v.msg), Hedwig_Foreign.attribute("ref")("text") ])([ Hedwig_Foreign.text(v.description) ]) ]);
  };
  var buttons = Data_Functor.map(Data_Functor.functorArray)(button)([ {
      id: "run",
  ...
  var view = function (model) {
      return Hedwig_Foreign.element("main")([ Hedwig_Property["class'"]("container") ])([ Hedwig_Element.div([ Hedwig_Property["class'"]("jumbotron") ])([ Hedwig_Element.div([ Hedwig_Property["class'"]("row") ])([ Hedwig_Element.div([ Hedwig_Property["class'"]("col-md-6") ])([ Hedwig_Element.h1([  ])([ Hedwig_Foreign.text("Hedwig") ]) ]), Hedwig_Element.div([ Hedwig_Property["class'"]("col-md-6") ])(buttons) ]) ]), Hedwig_Element.table([ Hedwig_Property["class'"]("table table-hover table-striped test-data"), Hedwig_Foreign.on("click")(handleTableClick) ])([ Hedwig_Element.tbody([  ])(Data_Functor.map(Data_Functor.functorArray)(viewRowLazy)(model.rows)) ]), Hedwig_Element.span([ Hedwig_Property["class'"]("preloadicon glyphicon glyphicon-remove"), Hedwig_Foreign.attribute("aria-hidden")("true") ])([  ]) ]);
  };
  var adjectives = [ "pretty", "large", "big", "small", "tall", "short", "long", "handsome", "plain", "quaint", "clean", "elegant", "easy", "angry", "crazy", "helpful", "mushy", "odd", "unsightly", "adorable", "important", "inexpensive", "cheap", "expensive", "fancy" ];
  var randomRows = function (lastId) {
      return function (length) {
          var row = function __do() {
              var v = choose(adjectives)();
              var v1 = choose(colors)();
              var v2 = choose(nouns)();
              return v + (" " + (v1 + (" " + v2)));
          };
          ...
          return Data_Functor.map(Effect.functorEffect)(Data_Array.mapWithIndex(f))(Data_Unfoldable.replicateA(Effect.applicativeEffect)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(length)(row));
      };
  };
  var update = function ($copy_model) {
      return function ($copy_v) {
          var $tco_var_model = $copy_model;
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(model, v) {
              if (v instanceof Create) {
                  $tco_var_model = {
                      rows: [  ],
                      nextId: model.nextId
                  };
                  $copy_v = new Append(v.value0);
                  return;
              };
              if (v instanceof Append) {
                  $tco_done = true;
                  return new Data_Tuple.Tuple(model, [ Control_Bind.bind(Effect_Aff.bindAff)(Hedwig.sync(randomRows(model.nextId)(v.value0)))(function (v1) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Push(v1));
                  }) ]);
              };
              if (v instanceof UpdateEvery) {
                  var f = function (v1) {
                      return function (row) {
                          if (Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v1)(v.value0) === 0) {
                              return {
                                  label: row.label + " !!!",
                                  id: row.id,
                  ...
                  return new Data_Tuple.Tuple({
                      rows: Data_Array.mapWithIndex(f)(model.rows),
                      nextId: model.nextId
                  }, [  ]);
              };
              ...
              if (v instanceof Swap) {
                  var v1 = Data_Array.index(model.rows)(998);
                  var v2 = Data_Array.index(model.rows)(1);
              ...
              if (v instanceof Select) {
                  ...
                  $tco_done = true;
                  return new Data_Tuple.Tuple({
                      rows: Data_Functor.map(Data_Functor.functorArray)(f)(model.rows),
                      nextId: model.nextId
                  }, [  ]);
              };
              if (v instanceof Remove) {
                  $tco_done = true;
                  return new Data_Tuple.Tuple({
                      rows: Data_Array.filter(function (row) {
                          return row.id !== v.value0;
                      })(model.rows),
                      nextId: model.nextId
                  }, [  ]);
              };
              if (v instanceof Push) {
                  $tco_done = true;
                  return new Data_Tuple.Tuple({
                      rows: Data_Semigroup.append(Data_Semigroup.semigroupArray)(model.rows)(v.value0),
                      nextId: model.nextId + Data_Array.length(v.value0) | 0
                  }, [  ]);
              };
              ...
              throw new Error("Failed pattern match at Examples.JsFrameworkBenchmark line 43, column 16 - line 81, column 16: " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_model, $copy_v);
          };
          return $tco_result;
      };
  };
  ...
  exports["Append"] = Append;
  exports["UpdateEvery"] = UpdateEvery;
  exports["Clear"] = Clear;
  exports["Swap"] = Swap;
  ...
  exports["randomRows"] = randomRows;
  exports["adjectives"] = adjectives;
  exports["colors"] = colors;
  exports["nouns"] = nouns;
  exports["view"] = view;
  exports["handleTableClick"] = handleTableClick;
  exports["viewRowLazy"] = viewRowLazy;
  exports["viewRow"] = viewRow;
  exports["buttons"] = buttons;
  exports["button"] = button;
})(PS["Examples.JsFrameworkBenchmark"] = PS["Examples.JsFrameworkBenchmark"] || {});
PS["Examples.JsFrameworkBenchmark"].main();
